...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*ContextPrioArgs)(nil), (*config.ContextPrioArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ContextPrioArgs_To_config_ContextPrioArgs(a.(*ContextPrioArgs), b.(*config.ContextPrioArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ContextPrioArgs)(nil), (*ContextPrioArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ContextPrioArgs_To_v1_ContextPrioArgs(a.(*config.ContextPrioArgs), b.(*ContextPrioArgs), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*NetworkTrafficArgs)(nil), (*config.NetworkTrafficArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_NetworkTrafficArgs_To_config_NetworkTrafficArgs(a.(*NetworkTrafficArgs), b.(*config.NetworkTrafficArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NetworkTrafficArgs)(nil), (*NetworkTrafficArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NetworkTrafficArgs_To_v1_NetworkTrafficArgs(a.(*config.NetworkTrafficArgs), b.(*NetworkTrafficArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ContextPrioArgs_To_config_ContextPrioArgs(in *ContextPrioArgs, out *config.ContextPrioArgs, s conversion.Scope) error {
...
// Convert_v1_ContextPrioArgs_To_config_ContextPrioArgs is an autogenerated conversion function.
func Convert_v1_ContextPrioArgs_To_config_ContextPrioArgs(in *ContextPrioArgs, out *config.ContextPrioArgs, s conversion.Scope) error {
	return autoConvert_v1_ContextPrioArgs_To_config_ContextPrioArgs(in, out, s)
}

func autoConvert_config_ContextPrioArgs_To_v1_ContextPrioArgs(in *config.ContextPrioArgs, out *ContextPrioArgs, s conversion.Scope) error {
...
// Convert_config_ContextPrioArgs_To_v1_ContextPrioArgs is an autogenerated conversion function.
func Convert_config_ContextPrioArgs_To_v1_ContextPrioArgs(in *config.ContextPrioArgs, out *ContextPrioArgs, s conversion.Scope) error {
	return autoConvert_config_ContextPrioArgs_To_v1_ContextPrioArgs(in, out, s)
}
...
func autoConvert_v1_NetworkTrafficArgs_To_config_NetworkTrafficArgs(in *NetworkTrafficArgs, out *config.NetworkTrafficArgs, s conversion.Scope) error {
	if err := metav1.Convert_Pointer_string_To_string(&in.Address, &out.Address, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_string_To_string(&in.NetworkInterface, &out.NetworkInterface, s); err != nil {
...
// Convert_v1_NetworkTrafficArgs_To_config_NetworkTrafficArgs is an autogenerated conversion function.
func Convert_v1_NetworkTrafficArgs_To_config_NetworkTrafficArgs(in *NetworkTrafficArgs, out *config.NetworkTrafficArgs, s conversion.Scope) error {
	return autoConvert_v1_NetworkTrafficArgs_To_config_NetworkTrafficArgs(in, out, s)
}

func autoConvert_config_NetworkTrafficArgs_To_v1_NetworkTrafficArgs(in *config.NetworkTrafficArgs, out *NetworkTrafficArgs, s conversion.Scope) error {
	if err := metav1.Convert_string_To_Pointer_string(&in.Address, &out.Address, s); err != nil {
		return err
	}
	if err := metav1.Convert_string_To_Pointer_string(&in.NetworkInterface, &out.NetworkInterface, s); err != nil {
...
// Convert_config_NetworkTrafficArgs_To_v1_NetworkTrafficArgs is an autogenerated conversion function.
func Convert_config_NetworkTrafficArgs_To_v1_NetworkTrafficArgs(in *config.NetworkTrafficArgs, out *NetworkTrafficArgs, s conversion.Scope) error {
	return autoConvert_config_NetworkTrafficArgs_To_v1_NetworkTrafficArgs(in, out, s)
}
