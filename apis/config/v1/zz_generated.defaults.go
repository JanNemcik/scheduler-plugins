...
func RegisterDefaults(scheme *runtime.Scheme) error {
	scheme.AddTypeDefaultingFunc(&ContextPrioArgs{}, func(obj interface{}) { SetObjectDefaults_ContextPrioArgs(obj.(*ContextPrioArgs)) })
...
func SetObjectDefaults_ContextPrioArgs(in *ContextPrioArgs) {
	SetDefaults_ContextPrioArgs(in)
}
